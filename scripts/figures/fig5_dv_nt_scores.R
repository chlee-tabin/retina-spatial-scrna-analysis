...
# %%
# NT-axis marker sets (same sets used to build NT.Score in 02_chick_dv_nt_scoring.R;
# duplicated from sfig14_nt_score.R because the F5E variant cell below groups genes by them)
genes.nasal <- c("FOXG1", "SOHO-1", "HMX1", "EFNA5", "EFNA2")  # nasal marker set curated by H.N.V. Joisher
genes.temporal <- c("FOXD1", "EPHA3")
