...
# cat <GEO GTF: GSE322831_GRCg6a_NCBI_extended3UTR.gtf.gz>  | gawk '($1 == "MT" && $3 == "gene")' 
...
# %% [markdown]
# # Genotyping
# This is following up the vireo genotyping pipeline again. See `raw/` original directory for details.
