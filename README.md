...
| Chick cluster-membership (with SF16) | `scripts/figures/sfig16_chick_spatial_clusters.py` | `figures/Tables/*_chick_cluster_members.tsv` |
| Human / mouse cluster-membership (with SF19) | `scripts/figures/sfig19_mouse_human_clusters.py` | `figures/Tables/*_{human,mouse}_cluster_members.tsv` |
...
their figure scripts into `figures/Tables/` (gitignored) and follow the
revised-manuscript supplementary numbering.
